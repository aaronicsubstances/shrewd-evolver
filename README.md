...
*Although syntax is the same, semantics is quite different with that specified on the Message Templates site:* 

   1. Keyword arguments are supplied as a single tree data structure separate from positional arguments, rather than being collected with capturing rules.
   ...
   1. Alignment and format options are not supported.
