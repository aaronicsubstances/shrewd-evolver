...
namespace AaronicSubstances.ShrewdEvolver
{
    public static class MicroOrmHelpers
    {
        ...
        }/*3. Function which can generate all possible combinations of boolean conditions (ie 2 exponent condition count) in order to test that all variations of generated query code snippets. An example is described as follows.
